...
export default class Vignerons extends Component {
  ...
  //     el.style.marginBottom = heightPara + 200 + "px";
  ...
  getRegion(region, regionData, index) {
    return (
      <div class="domaine-section">
        ...
        <div
          class={
            "container-polyedre container-poly-vignerons para container-polyedre-" +
            index
          }
          data-rellax-speed={Math.random() * (2.5 - 1)}
        >
          <img src={"../static/polyedre-" + index + ".png"} alt="" />
        </div>
      </div>
    );
  }
              ...
              <div class="container-content">
                ...
                <div class="container-list">
                  <div class="list-vigneron">
                    ...
                    <div class="txt-vigneron">
                      <p>
                        Un domaine que certains connaissent déjà. Mon style
                        préféré en vallée du Rhône Nord à savoir de la vendange
                        entière et peu ou pas de fûts neufs. Les Côte-Rôtie sont
                        des modèles d’élégance. 31 mois d’élevage sur « Emporium
                        » en parcellaire. Les robes sont violettes, brillantes,
                        intenses.
                      </p>
                    </div>
                  </div>
              ...
              <div class="container-content">
                ...
                <div class="container-list">
                  <div class="list-vigneron">
                    ...
                    <div class="txt-vigneron">
                      <p>
                        Un peu de Jura dans ce monde de Bourguignons et de
                        Bourguignonnes. C’est Hélène qui prend les commandes et
                        assure la continuité de ce superbe écrin crée par ses
                        parents en 1984. Une vision du Jura dans l’air du temps
                        avec des rouges pulpeux et frais, des savagnins non
                        ouillés* qui côtoient les grands classiques tel le
                        Château-Chalon et le fameux Vin de Paille. Sur
                        Château-Chalon, la garde est infinie (plusieurs
                        centaines d’années).
                      </p>
                      <br />
                      <p>
                        *l’ouillage : L'ouillage est une action périodique
                        visant à toujours maintenir le niveau maximal des fûts
                        et des cuves de vin dans une cave. Il compense les
                        pertes, ou « consume », dues à l'absorption et
                        l'évaporation.
                      </p>
                    </div>
                  </div>
